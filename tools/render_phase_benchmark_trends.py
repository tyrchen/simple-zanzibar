...
READ_SERIES = [
    Series("prepared check", (6.0009, 5.3424, 4.3065, 5.1530), "us", BLUE),
    Series("lookup resources", (3.1883, 2.7544, 2.3551, 3.3956), "ms", RED),
    Series("lookup subjects", (6.3451, 5.4722, 4.7426, 4.5348), "us", GREEN),
    Series("realworld inherited", (15.110, 14.833, 11.559, 11.692), "us", TEAL),
    Series("realworld mixed", (58.164, 53.489, 41.808, 41.975), "us", PURPLE),
    Series("heavy-write read", (17.844, 12.365, 12.712, 13.824), "us", AMBER),
]
...
def draw_takeaways(svg: Svg, x: float, y: float, width: float, height: float) -> None:
    ...
    notes = [
        ("Best continuation", "lookup_subjects is 4.4% faster than P14 and 28.5% faster than P12.", GREEN),
        ("Realistic reads", "inherited and mixed real-world reads are within 1.2% of P14 and >22% faster than P12.", TEAL),
        ("Main regression", "lookup_resources_streaming is 44.2% slower than P14 and 6.5% slower than P12.", RED),
        ("Micro regression", "prepared check is 19.7% slower than P14 but still 14.1% faster than P12.", AMBER),
